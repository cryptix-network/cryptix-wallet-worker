...
import {Wallet as WalletImpl, initCryptixFramework} from '@cryptix/wallet';
import {TxSend, TxInfo} from '@cryptix/wallet/types/custom-types';
...
export class WorkerCore extends EventEmitter{
	...
	async init(){
		...
		super.init();
		workerLog.debug("before initCryptixFramework")
		await initCryptixFramework();
		workerLog.debug("after initCryptixFramework")
